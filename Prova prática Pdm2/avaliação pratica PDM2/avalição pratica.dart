...
void main() async {
  ...
  await inserirEstudante(db, 'Lucas Venicio', 16);
  await inserirEstudante(db, '´José Maia', 17);
   await inserirEstudante(db, '´Otávio Emanuel', 17);
  ...
  await atualizarEstudante(db, 1, 'Lucas Venicio', 17);
  await atualizarEstudante(db, 1, 'Otávio Emanuel', 18);
